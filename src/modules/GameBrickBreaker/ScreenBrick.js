var ScreenBrick = cc.Layer.extend({
    ...
    ctor:function() {
        ...
        this.paddle = new cc.Sprite(res.PADDLE);
        ...
        this.ball.attr({
            ...
            y: this.paddle.getPosition().y + this.paddle.getBoundingBox().height + 7
        });
        this.addChild(this.ball);

        this.scoreLabel = new cc.LabelTTF("Score: 0", 30);
    ...
    addBricks: function(){
        let tmpBrick = new cc.Sprite(res.BRICK);
        ...
        for(let i = 0; i < this.BRICKS; i++){
            let brick = new cc.Sprite(res.BRICK);
